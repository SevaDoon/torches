...
export const ar = {
  ...
  teacher: {
    ...
    active: 'بدأن اللعب',
    activeNote: 'أجبن على سؤال واحد على الأقل',
    refresh: 'تحديث',
    ...
    deleteFailed: 'تعذّر الحذف. تأكّدي من الاتصال وصلاحيتك.',
  ...
  lesson: {
    tag: 'القاعدة أولاً',
    examples: 'أمثلة',
    note: 'اقرئي القاعدة والأمثلة، وبتلقينها تتكرر في التلميحات أثناء اللعب.',
    start: 'فهمت — ابدئي التحدي',
    button: 'القاعدة',
  },
