...
export const ar = {
  ...
  journey: {
    ...
    gated: 'أقفلتها المعلّمة — الصف يدرس وحدة أخرى الآن',
  ...
  teacher: {
    ...
    badge: 'معلّمة',
    reached: 'وصلت إلى',
    unitShort: (n: number) => `الوحدة ${n}`,
    gateTitle: 'إقفال الوحدات',
    gateNote:
      'اختاري آخر وحدة مسموح للطالبات بفتحها، حتى لا تسبق إحداهنّ الصف إلى وحدة لم تُدرَّس بعد. الوحدات التي قبلها تبقى مفتوحة كالمعتاد.',
    gateOff: 'بدون إقفال — كل الوحدات مفتوحة',
    gateUpTo: (n: number) => `حتى الوحدة ${n}`,
    gateSave: 'حفظ الإقفال',
    gateSaved: (n: number) =>
      n === 0 ? 'أُلغي الإقفال، الوحدات كلها مفتوحة.' : `أُقفلت الوحدات بعد الوحدة ${n}.`,
    gateFailed: 'تعذّر حفظ الإقفال. حاولي مرة أخرى.',
    rename: 'تعديل الاسم',
